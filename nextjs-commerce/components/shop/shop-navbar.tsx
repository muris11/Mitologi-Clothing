        ...
        <div className="mx-auto flex h-full w-full max-w-[1500px] items-center px-3 sm:px-4 lg:px-6 xl:px-8">
            ...
            <div className={desktopMenuShellClassName}>
              {menuItems.map((item) => {
                const isActive = item.path === '/shop' 
                  ? pathname.startsWith('/shop') && !pathname.startsWith('/shop/panduan-ukuran')
                  : pathname === item.path
                return (
                  <Link
                    key={item.path}
          ...
          <div className="flex min-w-0 items-center justify-end gap-2 lg:min-w-[180px]">
            ...
            {user ? (
              ...
              <Button asChild variant="primary" className="hidden lg:inline-flex h-10 shrink-0 rounded-full px-4 text-xs font-bold shadow-[0_12px_28px_rgba(185,149,91,0.28)] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(185,149,91,0.34)]">
                <Link href="/shop/login" className="flex items-center text-inherit">
          ...
          <div className="mx-4 rounded-[28px] border border-app bg-white shadow-[0_20px_60px_rgba(10,20,35,0.24)]">
            <div className="max-h-[calc(100vh-8rem)] overflow-y-auto px-5 py-6">
              ...
              <div className="mt-4 border-t border-slate-100 pt-4">
                {!user && (
                  <Button asChild className="h-12 w-full rounded-full text-sm font-bold shadow-[0_12px_28px_rgba(15,33,58,0.12)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(15,33,58,0.18)]" onClick={() => setIsMobileMenuOpen(false)} variant="primary">
