...
const transparentDesktopRoutes = ['/', '/tentang-kami', '/kategori', '/layanan', '/portofolio', '/kontak', '/privacy-policy', '/terms-of-service'];
...
export function LandingNavbar({ settings }: { settings?: SiteSettings }) {
  ...
  const logoSrc = storageUrl(settings?.general?.site_logo, '/images/logo.png');
            ...
            <div className="flex h-[72px] w-full items-center justify-between gap-3 xl:gap-4">
                ...
                <Link href="/" className="group flex items-center gap-2 py-2">
                  ...
                  <span
                    className={cn(
                      ...
                      isHeroState ? 'text-white drop-shadow-[0_6px_18px_rgba(10,20,35,0.45)]' : 'text-mitologi-navy'
                    )}
                  >
                    Mitologi Clothing
                  </span>
              ...
              <div className="flex min-w-0 items-center justify-end gap-2 lg:min-w-[180px]">
                <div className="hidden lg:flex">
                  <Button asChild className="inline-flex h-12 shrink-0 rounded-full px-5 text-sm font-bold text-mitologi-navy shadow-[0_12px_28px_rgba(185,149,91,0.28)] transition-all duration-300 ease-out hover:-translate-y-0.5 hover:shadow-[0_18px_36px_rgba(185,149,91,0.34)] group" variant="gold">
                    <Link href="/shop" className="text-mitologi-navy hover:text-mitologi-navy flex items-center">
                ...
                >
                  <MenuToggleIcon open={isMobileMenuOpen} className="h-7 w-7" duration={300} />
                </button>
              </div>
            </div>
          </div>
          ...
          <div className="mx-4 rounded-[28px] border border-app bg-white shadow-[0_20px_60px_rgba(10,20,35,0.24)]">
            <div className="max-h-[calc(100vh-8rem)] overflow-y-auto px-5 py-6">
                    ...
                    >
                      ...
                      <span
                        className={cn(
                          ...
                          isActive ? 'bg-mitologi-gold scale-100' : 'bg-slate-300 scale-0 group-hover:scale-100 group-hover:bg-mitologi-navy/30'
                        )}
                      />
              ...
              <div className="mt-4 border-t border-slate-100 pt-4">
                <Button asChild className="h-12 w-full rounded-full text-sm font-bold shadow-[0_12px_28px_rgba(15,33,58,0.12)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_16px_36px_rgba(15,33,58,0.18)]" variant="primary">
