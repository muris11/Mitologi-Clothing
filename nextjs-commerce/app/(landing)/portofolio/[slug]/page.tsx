...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  try {
    ...
    if (!portfolio) return { title: 'Portofolio Tidak Ditemukan | Mitologi Clothing' };

    return {
      title: `${portfolio.title} | Portofolio Mitologi Clothing`,
      description: portfolio.description || `Detail proyek ${portfolio.title} oleh Mitologi Clothing.`,
    };
  } catch {
