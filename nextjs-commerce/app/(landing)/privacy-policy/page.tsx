...
export default async function PrivacyPolicyPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      extra: 'Anda dapat mengatur pengaturan cookie melalui browser Anda. Namun, menonaktifkan cookie tertentu dapat memengaruhi fungsionalitas website.',
    },
    {
      title: '6. Hak Anda',
      content: [
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <p className="text-slate-600 leading-relaxed text-lg">
                <span className="font-semibold text-mitologi-navy">{siteName}</span> menghargai privasi Anda.
                Kebijakan Privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, menyimpan,
                dan melindungi informasi pribadi Anda saat menggunakan website dan layanan kami.
            ...
            <div className="mt-16 p-8 rounded-3xl bg-gradient-to-br from-mitologi-navy to-[#1a1a3e] text-white shadow-2xl shadow-mitologi-navy/20">
              ...
              <p className="text-slate-300 mb-8 leading-relaxed">
                Jika Anda memiliki pertanyaan mengenai Kebijakan Privasi ini atau ingin menggunakan hak Anda
