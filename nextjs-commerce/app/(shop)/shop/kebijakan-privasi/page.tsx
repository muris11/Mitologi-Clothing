      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="flex-1 min-w-0 prose max-w-none prose-headings:font-sans prose-headings:font-bold prose-headings:text-slate-800 prose-p:font-sans prose-p:text-slate-600 prose-p:leading-relaxed prose-li:font-sans prose-li:text-slate-600 prose-strong:font-bold prose-strong:text-slate-800 prose-a:text-mitologi-navy hover:prose-a:underline prose-a:font-semibold">
          ...
          <section id="pendahuluan" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">1. Pendahuluan</h2>
            <p>
          ...
          <section id="informasi" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">2. Informasi yang Kami Kumpulkan</h2>

            <h3 className="text-lg font-sans font-bold text-slate-800 mt-8 mb-4">a. Data Pribadi</h3>
            <p>Informasi yang Anda berikan secara langsung kepada kami, termasuk:</p>
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>Informasi pembayaran yang diproses melalui payment gateway</li>
            </ul>

            <h3 className="text-lg font-sans font-bold text-slate-800 mt-8 mb-4">b. Data Transaksi</h3>
            ...
            <h3 className="text-lg font-sans font-bold text-slate-800 mt-8 mb-4">c. Data Perangkat & Teknis</h3>
            <p>Informasi yang dikumpulkan secara otomatis saat Anda mengunjungi website kami:</p>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section id="penggunaan" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">3. Penggunaan Informasi</h2>
            <p>Kami menggunakan informasi yang dikumpulkan untuk tujuan berikut:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Pemrosesan Pesanan</strong>: Memproses, mengirimkan, dan mengelola pesanan Anda</li>
              <li><strong>Komunikasi</strong>: Mengirimkan konfirmasi pesanan, update pengiriman, dan notifikasi penting</li>
              <li><strong>Personalisasi</strong>: Memberikan rekomendasi produk yang relevan berdasarkan preferensi Anda</li>
              <li><strong>Peningkatan Layanan</strong>: Menganalisis pola penggunaan website untuk meningkatkan pengalaman berbelanja</li>
              <li><strong>Keamanan</strong>: Mendeteksi dan mencegah aktivitas penipuan atau penyalahgunaan</li>
              <li><strong>Pemasaran</strong>: Mengirimkan newsletter, penawaran khusus, dan informasi promo (dengan persetujuan Anda)</li>
            </ul>
          </section>

          <section id="perlindungan" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">4. Perlindungan Data</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Penyimpanan password menggunakan algoritma hashing yang aman</li>
              <li>Pembatasan akses data hanya kepada karyawan yang membutuhkan</li>
              <li>Pemrosesan pembayaran melalui gateway yang tersertifikasi PCI DSS (Midtrans)</li>
          ...
          <section id="pihak-ketiga" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">5. Berbagi Informasi dengan Pihak Ketiga</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Payment Gateway</strong>: Data pembayaran diproses oleh Midtrans untuk memfasilitasi transaksi</li>
              <li><strong>Jasa Pengiriman</strong>: Nama dan alamat pengiriman diberikan kepada kurir (JNE, J&T, SiCepat, dll.) untuk mengirimkan pesanan Anda</li>
              <li><strong>Kewajiban Hukum</strong>: Jika diwajibkan oleh hukum, regulasi, atau perintah pengadilan yang berlaku di Indonesia</li>
              <li><strong>Perlindungan Hak</strong>: Untuk melindungi hak, keamanan, atau properti kami, pengguna kami, atau publik</li>
            </ul>
          </section>

          <section id="hak-pengguna" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">6. Hak Pengguna</h2>
            <p>Anda memiliki hak-hak berikut terkait data pribadi Anda:</p>
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Hak Akses</strong>: Anda dapat mengakses dan meninjau data pribadi yang kami simpan tentang Anda melalui halaman akun Anda</li>
              <li><strong>Hak Koreksi</strong>: Anda dapat memperbarui atau memperbaiki data yang tidak akurat melalui pengaturan profil</li>
              <li><strong>Hak Penghapusan</strong>: Anda dapat meminta penghapusan akun dan data pribadi Anda dengan menghubungi kami</li>
              <li><strong>Hak Penarikan Persetujuan</strong>: Anda dapat berhenti berlangganan newsletter kapan saja melalui link unsubscribe</li>
            </ul>
            <p>
          ...
          <section id="cookie" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">7. Kebijakan Cookie</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li><strong>Cookie Esensial</strong>: Diperlukan untuk fungsi dasar website seperti autentikasi dan keranjang belanja</li>
              <li><strong>Cookie Preferensi</strong>: Menyimpan preferensi sesi Anda untuk pengalaman yang lebih personal</li>
              <li><strong>Cookie Analitik</strong>: Membantu kami memahami bagaimana pengunjung berinteraksi dengan website</li>
            </ul>
            <p>
          ...
          <section id="perubahan" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">8. Perubahan Kebijakan</h2>
            <p>
          ...
          <section id="kontak" className="scroll-mt-24 mb-14">
            <h2 className="text-2xl font-sans font-bold text-mitologi-navy mb-6">9. Hubungi Kami</h2>
            <p>
          ...
          <div className="mt-16 pt-8 border-t border-slate-200 flex flex-col sm:flex-row justify-between sm:items-center gap-6">
            <Link href="/shop/syarat-ketentuan" className="inline-flex items-center text-sm font-sans font-bold text-slate-600 hover:text-mitologi-navy transition-colors">
