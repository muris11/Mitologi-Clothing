        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-mitologi-navy/5 border border-slate-100 overflow-hidden mb-8">
          ...
          <ul className="divide-y divide-slate-100">
            {lines.map((line) => (
              <li
                key={line.id}
                className="p-6 md:px-8 flex flex-col sm:flex-row sm:items-center gap-6 hover:bg-slate-50/50 transition-colors"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-3xl shadow-xl shadow-mitologi-navy/5 border border-slate-100 p-6 md:p-8 flex flex-col h-full">
            <div className="flex items-center gap-3 mb-6 pb-6 border-b border-slate-100">
              ...
              <h3 className="font-sans font-extrabold text-mitologi-navy text-lg">
                Alamat Pengiriman
              </h3>
            </div>
            ...
            {order.refundRequestedAt && order.status === "processing" && (
              <div className="mt-6 pt-6 border-t border-slate-100">
                <div className="bg-amber-50 border border-amber-200 rounded-2xl p-5 flex items-start gap-4 shadow-sm">
                  ...
                  <div>
                    <h4 className="text-sm font-bold text-amber-800 font-sans">
                      Pengajuan Refund Sedang Diulas
                    </h4>
                    <p className="text-sm font-medium font-sans text-amber-700 mt-1.5 leading-relaxed">
                      Pengajuan pengembalian dana dikirim pada{" "}
                      {new Date(order.refundRequestedAt).toLocaleDateString(
                        "id-ID",
            ...
            {order.status === "processing" &&
              ...
              !showRefundForm && (
                <div className="mt-6 pt-6 border-t border-slate-100 text-center">
                  ...
                  <p className="text-xs font-sans font-medium text-slate-400 mt-3">
                    Akan ditinjau oleh tim admin Mitra
                  </p>
                </div>
              )}
            {order.status === "processing" &&
              ...
              showRefundForm && (
                <div className="mt-6 pt-6 border-t border-slate-100">
                  <div className="rounded-2xl border border-slate-200 bg-slate-50 p-5 space-y-4 shadow-sm">
                    ...
                    <p className="text-xs font-sans font-medium text-slate-400 text-center mt-2">
                      Pengajuan akan diverifikasi oleh sistem.
                    </p>
                  </div>
                </div>
              )}
