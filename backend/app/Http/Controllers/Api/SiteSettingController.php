...
class SiteSettingController extends Controller
{
    public function index(): JsonResponse
    {
        ...
        $settings = Cache::rememberForever('api.site_settings', function () {
        ...
        return $this->successResponse($this->toCamelCase($settings->toArray()), 'Pengaturan situs berhasil diambil');
    }
}
