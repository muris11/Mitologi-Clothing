...
<div x-data="{ 
        ...
        <template x-for="i in 5">
            <button type="button" 
                ...
                :class="{
                    ...
                    'text-gray-200 dark:text-gray-700': i > (hoverRating || rating)
                }"
            >
    ...
    <div class="bg-gray-100 dark:bg-gray-700 px-3 py-1 rounded-lg">
        <span class="text-sm font-bold text-mitologi-navy dark:text-whit" x-text="rating + ' / 5'"></span>
    </div>
</div>
