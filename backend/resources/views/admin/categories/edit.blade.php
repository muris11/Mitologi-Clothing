<x-admin-layout>
    <x-admin-header 
        ...
        :breadcrumbs="[['title' => 'Beranda', 'url' => route('admin.beranda.index')], ['title' => 'Kategori', 'url' => route('admin.categories.index')], ['title' => 'Edit']]"
        action_text="Batal" 
                ...
                <x-admin-card>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <x-text-input id="name" class="px-4 py-3 text-lg font-medium" type="text" name="name" x-model="name" @input="updateSlug" required autofocus />
                            <x-input-error :messages="$errors->get('name')" class="mt-2" />
                        </div>

                         <div>
                            <x-input-label for="description" :value="__('Deskripsi')" />
                            <x-textarea-input id="description" name="description" rows="5" placeholder="Deskripsi singkat untuk SEO...">{{ old('description', $category->description) }}</x-textarea-input>
            ...
            <div class="space-y-6">
                ...
                <!-- Media -->
                 <x-admin-card>
                    ...
                    <x-file-upload name="image" label="" :preview="$category->image" />
                </x-admin-card>
