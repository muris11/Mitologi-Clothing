                ...
                <div class="admin-panel p-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <x-text-input id="title" class="px-4 py-3 text-lg font-medium" type="text" name="title" x-model="title" @input="updateHandle" required autofocus placeholder="Contoh: Kaos Polos Premium" />
                ...
                <div class="admin-panel p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-file-upload name="image" label="Upload Gambar Utama" />
                        </div>
