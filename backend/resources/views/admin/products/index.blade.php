<x-admin-layout>
    <x-admin-header
        ...
        :breadcrumbs="[['title' => 'Toko Online', 'url' => '#'], ['title' => 'Produk']]"
            ...
            <table class="w-full text-left text-sm text-gray-600 ">
                ...
                <tbody class="divide-y divide-gray-100 ">
                    ...
                    <tr class="hover:bg-mitologi-cream/30  transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium border {{ $product->available_for_sale ? 'bg-green-100 text-green-800 border-green-200' : 'bg-gray-100 text-gray-800 border-gray-200' }}">
            ...
            @forelse($products as $product)
                <div class="p-4 bg-white  hover:bg-gray-50  transition-colors">
                    ...
                    <div class="flex items-center gap-2 mt-4 pt-3 border-t border-gray-100 ">
                        ...
                        <a href="{{ route('admin.products.edit', $product) }}" class="flex-1 inline-flex justify-center items-center px-3 py-2 bg-gray-50 hover:bg-gray-100 text-gray-700 text-xs font-medium rounded-lg transition-colors border border-gray-200">
