        ...
        <div class="space-y-6">
            ...
            <x-admin-card class="!p-0 border-0">
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Email Kontak</label>
                        <x-text-input type="email" name="contact_email" value="{{ $settings['contact_email'] ?? '' }}" class="w-full text-sm" />
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">No. WhatsApp</label>
                        <x-text-input name="whatsapp_number" value="{{ $settings['whatsapp_number'] ?? '' }}" placeholder="+62..." class="w-full text-sm" />
                    </div>
                    <div>
                        <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Telepon Kantor</label>
            ...
            <x-admin-card class="!p-0 border-0">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800 flex items-center gap-4">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">Jam Operasional</h3>
                </div>

                <div class="p-6">
                    {{-- Preview Box --}}
                    <div class="mb-6 border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
                        <div class="bg-gray-50/50 dark:bg-gray-800/50 px-4 py-3 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <div class="p-4 bg-white dark:bg-gray-800">
                            <ul class="space-y-3 text-sm font-medium text-gray-600 dark:text-gray-400">
                                <li class="flex justify-between border-b border-gray-100 dark:border-gray-700 pb-3">
                                    <span>{{ $settings['operating_hours_weekday_label'] ?? 'Senin - Sabtu' }}</span>
                                    <span class="font-bold text-gray-900 dark:text-white">{{ $settings['operating_hours_weekday'] ?? '08.00 - 16.00 WIB' }}</span>
                                </li>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {{-- Hari Kerja --}}
                        <div>
                            <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Label Hari Kerja</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Jam Ops Hari Kerja</label>
                        ...
                        {{-- Hari Libur --}}
                        <div>
                            <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Label Hari Libur</label>
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Jam Ops Hari Libur</label>
            ...
            <x-admin-card class="!p-0 border-0">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800 flex items-center gap-4">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">Lokasi Maps</h3>
                </div>
                
                <div class="p-6">
                    <label class="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Link Google Maps Embed</label>
                    ...
                    <p class="text-[11px] text-gray-500 mt-2 leading-relaxed">
                        ...
                        <br>• Koordinat (misal: <code class="bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded text-mitologi-navy dark:text-mitologi-gold">-6.438597, 108.287315</code>)
                        <br>• URL Embed (misal: <code class="bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded text-mitologi-navy dark:text-mitologi-gold">https://www.google.com/maps/embed?pb=...</code>)
                        <br>• Kode Iframe (misal: <code class="bg-gray-100 dark:bg-gray-700 px-1 py-0.5 rounded text-mitologi-navy dark:text-mitologi-gold">&lt;iframe src="..."&gt;&lt;/iframe&gt;</code>)
                    </p>
                </div>
            </x-admin-card>
            ...
            <x-admin-card class="!p-0 border-0">
                <div class="p-6 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800 flex items-center gap-4">
                    ...
                    <h3 class="text-lg font-bold text-gray-900 dark:text-white">Social Media & E-Commerce Link</h3>
                </div>
                
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    @foreach(['instagram'=>'Instagram', 'tiktok'=>'TikTok', 'facebook'=>'Facebook', 'shopee'=>'Shopee', 'twitter'=>'Twitter/X'] as $key => $label)
                    <div class="flex flex-col sm:flex-row sm:items-center gap-3 p-4 bg-gray-50/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="flex flex-col items-center flex-shrink-0">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <div class="w-9 h-5 bg-gray-200 peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-mitologi-navy/20 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all dark:border-gray-600 peer-checked:bg-mitologi-navy shadow-sm"></div>
                            </label>
                        </div>
                    </div>
                    @endforeach
