<x-admin-layout>
    ...
    <div class="space-y-6">
        <!-- Filters -->
        <div class="bg-white  rounded-2xl p-6 shadow-premium border border-gray-100 ">
            <form action="{{ route('admin.sales-report.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                ...
                <div>
                    ...
                    <select id="status" name="status" class="block mt-1 w-full px-4 py-3 border border-gray-300  bg-white  text-gray-900  focus:ring-2 focus:ring-mitologi-gold/50 focus:border-mitologi-gold rounded-xl shadow-sm transition-all duration-200">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <!-- Total Revenue -->
            <div class="bg-white  rounded-2xl p-6 shadow-premium border border-gray-100  transition-colors sm:col-span-2 lg:col-span-1">
                ...
                <p class="text-2xl font-bold text-mitologi-navy ">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</p>
            ...
            <!-- Total Orders -->
            <div class="bg-white  rounded-2xl p-6 shadow-premium border border-gray-100  transition-colors">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-2xl font-bold text-mitologi-navy ">{{ number_format($totalOrders) }}</p>
            ...
            <div class="bg-white  rounded-2xl p-6 shadow-premium border border-gray-100  transition-colors">
                ...
                <p class="text-2xl font-bold text-mitologi-navy ">Rp {{ number_format($avgOrderValue, 0, ',', '.') }}</p>
                    ...
                    <tbody class="divide-y divide-gray-100 ">
                        ...
                        <tr class="hover:bg-mitologi-cream/30  transition-colors group">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="font-mono text-sm font-medium text-mitologi-navy ">{{ $order->order_number }}</span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                {{ $order->created_at->format('d M Y H:i') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-bold text-mitologi-navy ">{{ $order->user ? $order->user->name : ($order->shippingAddress->name ?? 'Guest') }}</div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-mitologi-navy ">
                                Rp {{ number_format($order->total, 0, ',', '.') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ route('admin.orders.show', $order->id) }}" class="text-mitologi-navy hover:text-mitologi-gold   transition-colors p-1.5 hover:bg-gray-100  rounded-lg inline-block">
                ...
                <div class="p-4 hover:bg-gray-50  transition-colors">
                    ...
                    <div class="flex justify-between items-end">
                        <div class="space-y-0.5">
                            <div class="text-sm font-bold text-mitologi-navy ">
                        ...
                        <div class="text-right">
                            <div class="text-sm font-black text-mitologi-navy ">
                                Rp {{ number_format($order->total, 0, ',', '.') }}
                            </div>
