                    ...
                    <tr class="hover:bg-mitologi-cream/30 dark:hover:bg-gray-700/30 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="h-16 w-16 rounded-xl bg-gray-100 dark:bg-gray-700 overflow-hidden shadow-sm mr-4 flex-shrink-0 border border-gray-200 dark:border-gray-600 relative group-hover:shadow-md transition-shadow">
                                    @if($item->image_url)
                                ...
                                <div class="font-bold text-mitologi-navy dark:text-white text-base group-hover:text-mitologi-gold transition-colors">{{ $item->title }}</div>
                            </div>
                        </td>
                        <td class="px-6 py-4">
                            <span class="px-2.5 py-1 rounded-lg bg-gray-100 dark:bg-gray-700 text-xs font-medium text-gray-600 dark:text-gray-300 border border-gray-200 dark:border-gray-600">
                                {{ $item->category }}
                            </span>
                        </td>
                        <td class="px-6 py-4">
                            <span class="font-mono text-gray-500 dark:text-gray-400">#{{ $item->sort_order }}</span>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-3">
                                <a href="{{ route('admin.beranda.portfolio.edit', $item->id) }}" class="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white p-1.5 text-mitologi-navy shadow-sm transition-colors hover:bg-gray-100 hover:text-mitologi-gold dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500 bg-gray-50/30 dark:bg-gray-800/50">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Belum ada portfolio</h3>
            ...
            @forelse($items as $item)
                <div class="p-4 flex flex-col gap-3 bg-white dark:bg-gray-800">
                    <div class="relative h-48 w-full rounded-xl overflow-hidden shadow-sm group">
                        ...
                        @else
                            <div class="h-full w-full flex items-center justify-center text-gray-400 bg-gray-100 dark:bg-gray-700">
