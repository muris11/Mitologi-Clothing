<x-admin-layout>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-premium overflow-hidden border border-gray-100 dark:border-gray-700">
            ...
            <table class="w-full text-left text-sm text-gray-600 dark:text-gray-400">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700/50">
                    ...
                    <tr class="hover:bg-mitologi-cream/30 dark:hover:bg-gray-700/30 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="h-24 w-40 rounded-lg bg-gray-100 dark:bg-gray-700 overflow-hidden shadow-sm relative group-hover:shadow-md transition-all">
                                @if($slide->image_url)
                        ...
                        <td class="px-6 py-4">
                            <div class="font-bold text-mitologi-navy dark:text-white text-base mb-1">{{ $slide->title }}</div>
                         ...
                         <td class="px-6 py-4 text-center font-bold text-mitologi-navy/50 dark:text-white/50 text-lg">
                            #{{ $slide->sort_order }}
                        </td>
                        <td class="px-6 py-4">
                    ...
                    <tr>
                         <td colspan="5" class="px-6 py-12 text-center text-gray-500 bg-gray-50/30 dark:bg-gray-800/50">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Belum ada slide</h3>
        ...
        <div class="md:hidden divide-y divide-gray-100 dark:divide-gray-700">
            @forelse($slides as $slide)
                <div class="p-4 flex flex-col gap-4 bg-white dark:bg-gray-800">
                    {{-- Top Section: Image --}}
                    <div class="w-full aspect-video rounded-lg bg-gray-100 dark:bg-gray-700 overflow-hidden shadow-sm relative">
                        @if($slide->image_url)
                    ...
                    <div class="flex-1">
                        <h3 class="font-bold text-mitologi-navy dark:text-white text-base mb-1 line-clamp-2">{{ $slide->title }}</h3>
