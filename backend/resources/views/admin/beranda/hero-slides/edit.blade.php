<x-admin-layout>
    ...
    <form action="{{ route('admin.beranda.hero-slides.update', $heroSlide) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
                 ...
                 <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-premium p-6 border border-gray-100 dark:border-gray-700">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-file-upload name="image" label="Upload Background Slide" :preview="$heroSlide->image_url" />
                        </div>
