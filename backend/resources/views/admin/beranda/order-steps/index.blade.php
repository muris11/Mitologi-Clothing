            ...
            <table class="w-full text-left text-sm text-gray-600 ">
                ...
                <tbody class="divide-y divide-gray-100 ">
                    ...
                    <tr class="hover:bg-mitologi-cream/30  transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <div class="font-bold text-mitologi-navy ">{{ $step->title }}</div>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 max-w-md">
                            <p class="text-gray-600  truncate">{{ $step->description }}</p>
                        </td>
                        <td class="px-6 py-4 text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-3">
                                <a href="{{ route('admin.beranda.order-steps.edit', $step) }}" class="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white p-1.5 text-mitologi-navy shadow-sm transition-colors hover:bg-gray-100 hover:text-mitologi-gold     ">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500 bg-gray-50/30 ">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 ">Belum ada langkah pemesanan</h3>
                ...
                <div class="p-4 flex flex-col gap-3 bg-white ">
                    <div class="flex justify-between items-start">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-bold text-mitologi-navy  text-base">{{ $step->title }}</h3>
                    ...
                    <p class="text-sm text-gray-600  line-clamp-2 bg-gray-50  p-3 rounded-lg border border-gray-100 ">
                        {{ $step->description }}
                    </p>
