                    ...
                    <tr class="hover:bg-mitologi-cream/30 dark:hover:bg-gray-700/30 transition-colors group">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="h-12 w-24 rounded-lg bg-gray-100 dark:bg-gray-700 overflow-hidden shadow-sm mr-4 flex-shrink-0 border border-gray-200 dark:border-gray-600 relative flex items-center justify-center p-2">
                                    @if($partner->logo)
                                ...
                                <div>
                                    <div class="font-bold text-mitologi-navy dark:text-white text-base group-hover:text-mitologi-gold transition-colors">{{ $partner->name }}</div>
                        ...
                        <td class="px-6 py-4">
                            <span class="font-mono text-gray-500 dark:text-gray-400">#{{ $partner->sort_order }}</span>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-3">
                                <a href="{{ route('admin.beranda.partners.edit', $partner->id) }}" class="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white p-1.5 text-mitologi-navy shadow-sm transition-colors hover:bg-gray-100 hover:text-mitologi-gold dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500 bg-gray-50/30 dark:bg-gray-800/50">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Belum ada partner</h3>
            ...
            @forelse($partners as $partner)
                <div class="p-4 flex flex-col gap-3 bg-white dark:bg-gray-800">
                    <div class="flex items-center gap-3">
                        <div class="h-14 w-24 rounded-lg bg-gray-100 dark:bg-gray-700 overflow-hidden shadow-sm flex-shrink-0 border border-gray-200 dark:border-gray-600 flex items-center justify-center p-2">
                            @if($partner->logo)
                                <img src="{{ asset('storage/' . $partner->logo) }}" alt="{{ $partner->name }}" class="max-h-full max-w-full object-contain">
                            @else
                                <span class="text-xs text-gray-400">No Logo</span>
                        ...
                        <div class="flex-1">
                            <div class="flex justify-between items-start">
                                <h3 class="font-bold text-mitologi-navy dark:text-white text-base">{{ $partner->name }}</h3>
