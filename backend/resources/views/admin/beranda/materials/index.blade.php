            ...
            <table class="w-full text-left text-sm text-gray-600 dark:text-gray-400">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-700/50">
                    ...
                    <tr class="hover:bg-mitologi-cream/30 dark:hover:bg-gray-700/30 transition-colors group">
                        ...
                        <td class="px-6 py-4">
                            <div class="font-bold text-mitologi-navy dark:text-white">{{ $material->name }}</div>
                        </td>
                        <td class="px-6 py-4 max-w-sm">
                            <p class="text-gray-600 dark:text-gray-300 truncate">{{ $material->description }}</p>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right text-sm font-medium">
                            <div class="flex items-center justify-end space-x-3">
                                <a href="{{ route('admin.beranda.materials.edit', $material) }}" class="inline-flex items-center justify-center rounded-lg border border-slate-200 bg-white p-1.5 text-mitologi-navy shadow-sm transition-colors hover:bg-gray-100 hover:text-mitologi-gold dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700 dark:hover:text-white">
                    ...
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-center text-gray-500 bg-gray-50/30 dark:bg-gray-800/50">
                            <div class="flex flex-col items-center justify-center">
                                ...
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">Belum ada material</h3>
            ...
            @forelse($materials as $material)
                <div class="p-4 flex flex-col gap-3 bg-white dark:bg-gray-800">
                    <div class="flex justify-between items-start">
                        <div>
                            <h3 class="font-bold text-mitologi-navy dark:text-white text-base">{{ $material->name }}</h3>
                    ...
                    <div class="flex items-center gap-2 pt-2 border-t border-gray-50 dark:border-gray-700/50 mt-1">
