...
Route::prefix('portfolios')->group(function () {
  ...
  Route::get('/{slug}', [\App\Http\Controllers\Api\PortfolioController::class, 'show']);
});
...
Route::prefix('auth')->group(function () {
  ...
  Route::post('/forgot-password', [ForgotPasswordController::class, 'sendResetLink'])->middleware('throttle:auth');
  Route::post('/reset-password', [ForgotPasswordController::class, 'resetPassword'])->middleware('throttle:auth');
...
|--------------------------------------------------------------------------
*/
Route::post('/chatbot', [\App\Http\Controllers\Api\ChatbotController::class, 'chat'])->middleware('throttle:chatbot');
